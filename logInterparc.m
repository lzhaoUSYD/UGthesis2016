function [pt,dudt,fofthandle] = logInterparc(t,px,py,varargin)
% Tweaked by Luke Zhao 06/08/2016 for logarithmically increasing interval
% lengths.
...
%   % equally spaced in arclength
  % logarithmically spaced in arclength
  t = logspace(0,log(2)/log(10),t)';
